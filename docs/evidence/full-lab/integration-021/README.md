...
本批仅证明指定组合版本在本机的工程检查和所列真实页面操作，不代表A组最终交付。源码来源：A2 #20 的 `5d3bafa7a83a356ad66b7f8c8a47539ab9bbba72`，合入 A1 #21 的 `42095d2b84d4f6a5129565f9b7b0cf40854d0359`；组合提交见[PR #22](https://github.com/KnowCooker/RNC_3D_SIMULATION/pull/22)。两个角色仍在独立分支工作。
