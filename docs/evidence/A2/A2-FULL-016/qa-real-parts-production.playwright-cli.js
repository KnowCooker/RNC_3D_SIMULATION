...
async (page) => {
  ...
  if(partCount!==10||!before.startsWith('已拆 1')||after!==before||loaded!==1||errors.length||external.length)throw new Error(JSON.stringify({partCount,before,after,loaded,errors,external}));
