...
本批从 A2-FULL-008 已提交版本 `d74522a` 开发，对应[草稿 PR #14](https://github.com/KnowCooker/RNC_3D_SIMULATION/pull/14)。经验证运行源码 SHA 为 `56027760f426724a2e4b2ad4f5404be318403214`，原仓库 verify CI 已通过；本次文档固定提交不改变运行源码，草稿 PR 未合入 main。
