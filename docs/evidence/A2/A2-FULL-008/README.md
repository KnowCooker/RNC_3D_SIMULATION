...
本批从 A2-FULL-007 已提交基线 `e32a40c` 开发，对应[草稿 PR #13](https://github.com/KnowCooker/RNC_3D_SIMULATION/pull/13)。经验证的运行源码 SHA 为 `6efa36a98d16cedbfc495eec7cef7eb9abc20288`，原仓库 verify CI 已通过；本次文档固定提交不改变运行源码，未合并 PR 不能当作 main 已交付。
